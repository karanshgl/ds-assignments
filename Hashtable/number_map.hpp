...
template <typename K, typename V>
int Number_Map<K,V>::integer_cast(K str){
...
template <typename K, typename V>
int Number_Map<K,V>::component_sum(K str){
...
template <typename K, typename V>
int Number_Map<K,V>::polynomial_sum(K str){
	// Takes characters as coefficients of a polynomial
	int a = 33;
	int toRet = 0;
	for(K i=str; i>0;i=i>>8){
		int byte = (i&255);
		toRet = (byte) + a*toRet;
	}
...
template <typename K, typename V>
int Number_Map<K,V>::cycle_shift(K str){
...
template <typename K, typename V>
int Number_Map<K,V>::divide(int code){
	// h = |k| mod m
	int greaterPrime = 743;

	return ( code > 0 ? code%greaterPrime : (-code)%greaterPrime );
}

template <typename K, typename V>
int Number_Map<K,V>::mad(int code){
	// h = |ak + b| mod m
	int a = 500;
	int b = 211;
	int greaterPrime = 743;
...
template <typename K, typename V>
int Number_Map<K,V>::multiply(int code){
	// h = m(kA mod 1)
	if(code<0) code = -code;
	int greaterPrime = 743;
...
template <typename K, typename V>
void Number_Map<K,V>::insert(Node<K,V> *&head, K k, V v, int i){
...
template <typename K, typename V>
void Number_Map<K,V>::remove(Node<K,V> *&head, K key){
	if(head == NULL) return;
...
template <typename K, typename V>
V& Number_Map<K,V>::search(Node<K,V> *head, K key){
...
template <typename K, typename V>
void Number_Map<K,V>::input(string s){
